...
| `zookeeper.image.tag`                | ZooKeeper image tag                       | `0.12.0`                                             |
...
| `topicOperator.image.tag`            | Topic Operator s2i image tag              | `0.12.0`                                             |
...
| `tlsSidecarZookeeper.image.tag`      | TLS Sidecar for ZooKeeper image tag       | `0.12.0`                                             |
...
| `tlsSidecarKafka.image.tag`          | TLS Sidecar for Kafka image tag           | `0.12.0`                                             |
...
| `tlsSidecarTopicOperator.image.tag`  | TLS Sidecar for Topic Operator image tag  | `0.12.0`                                             |
